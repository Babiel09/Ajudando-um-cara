...
class bingoController {
    static get(req, reply) {
        return __awaiter(this, void 0, void 0, function* () {
            const mostrar = new bingoService_1.ShowAll();
            try {
    ...
    static post(req, reply) {
        return __awaiter(this, void 0, void 0, function* () {
            const inserir = new bingoService_1.InsertIntoDB();
            try {
                const { nome } = req.body;
                if (!nome) {
                ...
                ;
                const postedBingo = yield inserir.execute({ nome });
                if (!postedBingo) {
                    reply.status(500).send({ server: "Fi, Fudeu" });
                    throw new Error();
                }
    ...
    static delete(req, reply) {
        return __awaiter(this, void 0, void 0, function* () {
            const deletar = new bingoService_1.Delete();
            try {
                const { id } = req.params;
                if (!id) {
    ...
    static getById(req, reply) {
        return __awaiter(this, void 0, void 0, function* () {
            const mostrarUm = new bingoService_1.ShowOne();
            try {
                const { id } = req.params;
                if (!id) {
                    reply.status(400).send({ server: "Fi, passa o id pra nós!" });
    ...
    static put(req, reply) {
        return __awaiter(this, void 0, void 0, function* () {
            const atualizar = new bingoService_1.Update();
            try {
                const { id } = req.params;
                const { nome } = req.body;
                if (!id) {
                ...
                ;
                const updetedBingo = yield atualizar.execute({ id, nome });
                if (!updetedBingo) {
...
exports.bingoController = bingoController;
;
