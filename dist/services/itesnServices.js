...
class InsertIntoDB {
    execute(_a) {
        return __awaiter(this, arguments, void 0, function* ({ nome, price }) {
            try {
                const postedBingo = yield prismaClient.itens.create({
                    data: {
                        nome: nome,
                        price: price
                    }
...
class ShowAll {
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const findedBingo = yield prismaClient.itens.findMany();
                if (!findedBingo) {
...
class ShowOne {
    execute(_a) {
        return __awaiter(this, arguments, void 0, function* ({ id }) {
            try {
                const findJustOneBingo = yield prismaClient.itens.findFirst({
                    where: {
                        id: id
                    }
                });
...
class Delete {
    execute(_a) {
        return __awaiter(this, arguments, void 0, function* ({ id }) {
            try {
                const deleteBingo = yield prismaClient.itens.delete({
                    where: {
                        id: id
                    }
                });
...
class Update {
    execute(_a) {
        return __awaiter(this, arguments, void 0, function* ({ id, nome, price }) {
            try {
                const findTheId = yield prismaClient.itens.findFirst({
                    where: {
                        id: id
                    }
                });
                ...
                ;
                const updateTheBingp = yield prismaClient.itens.update({
                    where: {
                        id: findTheId.id
                    },
                    data: {
